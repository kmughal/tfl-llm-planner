...
const EUROSTAR_TOOLS = new Set(["get_euromap_plans", "get_euromap_technical_plans", "get_euromap_plan_by_id", "get_euromap_technical_plan_by_id", "get_eurostar_dashboard"])
...
export default function App() {
  ...
  return (
    <div className="flex flex-col h-screen relative" style={{ background: "transparent" }}>
      ...
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-sm border-b border-claude-border shadow-sm relative z-10">
        <NetworkStripe />
